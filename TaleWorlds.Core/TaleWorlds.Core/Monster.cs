...
public sealed class Monster : MBObjectBase
{
	...
	public override void Deserialize(MBObjectManager objectManager, XmlNode node)
	{
		...
		if (xmlAttribute != null && !string.IsNullOrEmpty(xmlAttribute.Value))
		{
			...
			Monster @object = objectManager.GetObject<Monster>(BaseMonster);
			if (!string.IsNullOrEmpty(@object.BaseMonster))
			{
				BaseMonster = @object.BaseMonster;
			}
			BodyCapsuleRadius = @object.BodyCapsuleRadius;
			BodyCapsulePoint1 = @object.BodyCapsulePoint1;
			BodyCapsulePoint2 = @object.BodyCapsulePoint2;
			CrouchedBodyCapsuleRadius = @object.CrouchedBodyCapsuleRadius;
			CrouchedBodyCapsulePoint1 = @object.CrouchedBodyCapsulePoint1;
			CrouchedBodyCapsulePoint2 = @object.CrouchedBodyCapsulePoint2;
			Flags = @object.Flags;
			Weight = @object.Weight;
			HitPoints = @object.HitPoints;
			ActionSetCode = @object.ActionSetCode;
			FemaleActionSetCode = @object.FemaleActionSetCode;
			MonsterUsage = @object.MonsterUsage;
			NumPaces = @object.NumPaces;
			WalkingSpeedLimit = @object.WalkingSpeedLimit;
			CrouchWalkingSpeedLimit = @object.CrouchWalkingSpeedLimit;
			JumpAcceleration = @object.JumpAcceleration;
			AbsorbedDamageRatio = @object.AbsorbedDamageRatio;
			SoundAndCollisionInfoClassName = @object.SoundAndCollisionInfoClassName;
			RiderCameraHeightAdder = @object.RiderCameraHeightAdder;
			RiderBodyCapsuleHeightAdder = @object.RiderBodyCapsuleHeightAdder;
			RiderBodyCapsuleForwardAdder = @object.RiderBodyCapsuleForwardAdder;
			StandingChestHeight = @object.StandingChestHeight;
			StandingPelvisHeight = @object.StandingPelvisHeight;
			StandingEyeHeight = @object.StandingEyeHeight;
			CrouchEyeHeight = @object.CrouchEyeHeight;
			MountedEyeHeight = @object.MountedEyeHeight;
			RiderEyeHeightAdder = @object.RiderEyeHeightAdder;
			EyeOffsetWrtHead = @object.EyeOffsetWrtHead;
			FirstPersonCameraOffsetWrtHead = @object.FirstPersonCameraOffsetWrtHead;
			ArmLength = @object.ArmLength;
			ArmWeight = @object.ArmWeight;
			JumpSpeedLimit = @object.JumpSpeedLimit;
			RelativeSpeedLimitForCharge = @object.RelativeSpeedLimitForCharge;
			FamilyType = @object.FamilyType;
			list = new List<sbyte>(@object.IndicesOfRagdollBonesToCheckForCorpses);
			list2 = new List<sbyte>(@object.RagdollFallSoundBoneIndices);
			HeadLookDirectionBoneIndex = @object.HeadLookDirectionBoneIndex;
			SpineLowerBoneIndex = @object.SpineLowerBoneIndex;
			SpineUpperBoneIndex = @object.SpineUpperBoneIndex;
			ThoraxLookDirectionBoneIndex = @object.ThoraxLookDirectionBoneIndex;
			NeckRootBoneIndex = @object.NeckRootBoneIndex;
			PelvisBoneIndex = @object.PelvisBoneIndex;
			RightUpperArmBoneIndex = @object.RightUpperArmBoneIndex;
			LeftUpperArmBoneIndex = @object.LeftUpperArmBoneIndex;
			FallBlowDamageBoneIndex = @object.FallBlowDamageBoneIndex;
			TerrainDecalBone0Index = @object.TerrainDecalBone0Index;
			TerrainDecalBone1Index = @object.TerrainDecalBone1Index;
			...
			MainHandBoneIndex = @object.MainHandBoneIndex;
			OffHandBoneIndex = @object.OffHandBoneIndex;
			MainHandItemBoneIndex = @object.MainHandItemBoneIndex;
			OffHandItemBoneIndex = @object.OffHandItemBoneIndex;
			MainHandItemSecondaryBoneIndex = @object.MainHandItemSecondaryBoneIndex;
			OffHandItemSecondaryBoneIndex = @object.OffHandItemSecondaryBoneIndex;
			OffHandShoulderBoneIndex = @object.OffHandShoulderBoneIndex;
			HandNumBonesForIk = @object.HandNumBonesForIk;
			PrimaryFootBoneIndex = @object.PrimaryFootBoneIndex;
			SecondaryFootBoneIndex = @object.SecondaryFootBoneIndex;
			RightFootIkEndEffectorBoneIndex = @object.RightFootIkEndEffectorBoneIndex;
			LeftFootIkEndEffectorBoneIndex = @object.LeftFootIkEndEffectorBoneIndex;
			RightFootIkTipBoneIndex = @object.RightFootIkTipBoneIndex;
			LeftFootIkTipBoneIndex = @object.LeftFootIkTipBoneIndex;
			FootNumBonesForIk = @object.FootNumBonesForIk;
			ReinHandleLeftLocalPosition = @object.ReinHandleLeftLocalPosition;
			ReinHandleRightLocalPosition = @object.ReinHandleRightLocalPosition;
			ReinSkeleton = @object.ReinSkeleton;
			ReinCollisionBody = @object.ReinCollisionBody;
			FrontBoneToDetectGroundSlopeIndex = @object.FrontBoneToDetectGroundSlopeIndex;
			BackBoneToDetectGroundSlopeIndex = @object.BackBoneToDetectGroundSlopeIndex;
			list7 = new List<sbyte>(@object.BoneIndicesToModifyOnSlopingGround);
			BodyRotationReferenceBoneIndex = @object.BodyRotationReferenceBoneIndex;
			RiderSitBoneIndex = @object.RiderSitBoneIndex;
			ReinHandleBoneIndex = @object.ReinHandleBoneIndex;
			ReinCollision1BoneIndex = @object.ReinCollision1BoneIndex;
			ReinCollision2BoneIndex = @object.ReinCollision2BoneIndex;
			ReinHeadBoneIndex = @object.ReinHeadBoneIndex;
			ReinHeadRightAttachmentBoneIndex = @object.ReinHeadRightAttachmentBoneIndex;
			ReinHeadLeftAttachmentBoneIndex = @object.ReinHeadLeftAttachmentBoneIndex;
			ReinRightHandBoneIndex = @object.ReinRightHandBoneIndex;
			ReinLeftHandBoneIndex = @object.ReinLeftHandBoneIndex;
		}
		else
		{
