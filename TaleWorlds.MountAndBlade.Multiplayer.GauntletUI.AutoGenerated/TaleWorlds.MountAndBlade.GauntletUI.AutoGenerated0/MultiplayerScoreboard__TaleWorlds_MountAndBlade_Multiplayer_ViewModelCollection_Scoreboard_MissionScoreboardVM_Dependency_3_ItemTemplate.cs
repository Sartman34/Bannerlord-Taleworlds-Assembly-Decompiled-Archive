...
public class MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_3_ItemTemplate : MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_8_MultiplayerScoreboardSideInner__InheritedPrefab
{
	private MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_8_MultiplayerScoreboardSideInner__InheritedPrefab _widget;

	private MissionScoreboardSideVM _datasource_Root;

	public MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_3_ItemTemplate(UIContext context)
		: base(context)
	{
	}
