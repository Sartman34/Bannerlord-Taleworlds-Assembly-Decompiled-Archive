...
public class MultiplayerDuel__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_MultiplayerDuelVM_Dependency_6_ItemTemplate : ListPanel
{
	...
	public void CreateWidgets()
	{
		...
		_widget_1_0 = new DuelArenaFlagVisualBrushWidget(base.Context);
		_widget_1.AddChild(_widget_1_0);
		_widget_1_1 = new DuelArenaFlagVisualBrushWidget(base.Context);
	...
	public void SetAttributes()
	{
		...
		_widget_0.Brush = base.Context.GetBrush("MPHUD.Duel.Card.NameText");
		...
		_widget_1_0.SuggestedWidth = 48f;
		_widget_1_0.SuggestedHeight = 55f;
		_widget_1_0.Brush = base.Context.GetBrush("MPHUD.Duel.Card.Flag.Background");
		_widget_1_1.WidthSizePolicy = SizePolicy.Fixed;
		_widget_1_1.HeightSizePolicy = SizePolicy.Fixed;
		_widget_1_1.SuggestedWidth = 33f;
		_widget_1_1.SuggestedHeight = 33f;
		...
		_widget_1_1.Brush = base.Context.GetBrush("MPHUD.Duel.Arena.Flag.Foreground");
	}
	...
	private void HandleWidgetPropertyChangeOf_widget(string propertyName)
	{
		...
		{
			_datasource_Root.IsFocused = _widget.IsVisible;
		}
	}
	...
	private void HandleViewModelPropertyChangeOf_datasource_Root(string propertyName)
	{
		...
		{
		case "IsFocused":
			_widget.IsVisible = _datasource_Root.IsFocused;
			break;
