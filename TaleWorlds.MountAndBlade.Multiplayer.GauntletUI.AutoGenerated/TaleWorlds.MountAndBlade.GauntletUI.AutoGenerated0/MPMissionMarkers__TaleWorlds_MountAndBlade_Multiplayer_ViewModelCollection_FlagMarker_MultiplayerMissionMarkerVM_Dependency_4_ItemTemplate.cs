...
public class MPMissionMarkers__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_FlagMarker_MultiplayerMissionMarkerVM_Dependency_4_ItemTemplate : AlwaysVisibleNameMarkerListPanel
{
	private AlwaysVisibleNameMarkerListPanel _widget;

	private Widget _widget_0;

	private MissionAlwaysVisibleMarkerTargetVM _datasource_Root;

	public MPMissionMarkers__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_FlagMarker_MultiplayerMissionMarkerVM_Dependency_4_ItemTemplate(UIContext context)
		: base(context)
	{
	}
	...
	public void SetAttributes()
	{
		...
		_widget_0.Sprite = base.Context.SpriteData.GetSprite("General\\Mission\\PersonalKillfeed\\kill_icon");
	}
	...
	private void RefreshDataSource_datasource_Root(MissionAlwaysVisibleMarkerTargetVM newDataSource)
	{
		if (_datasource_Root != null)
		{
			_datasource_Root.PropertyChanged -= ViewModelPropertyChangedListenerOf_datasource_Root;
