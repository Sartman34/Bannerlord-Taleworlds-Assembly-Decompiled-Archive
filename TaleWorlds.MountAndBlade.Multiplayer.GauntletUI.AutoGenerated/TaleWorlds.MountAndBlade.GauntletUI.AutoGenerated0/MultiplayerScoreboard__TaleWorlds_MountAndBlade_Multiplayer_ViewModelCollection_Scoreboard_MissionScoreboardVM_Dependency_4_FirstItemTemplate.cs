...
public class MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_4_FirstItemTemplate : MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_9_MultiplayerScoreboardSideInner__InheritedPrefab
{
	private MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_9_MultiplayerScoreboardSideInner__InheritedPrefab _widget;

	private MissionScoreboardSideVM _datasource_Root;

	public MultiplayerScoreboard__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_Scoreboard_MissionScoreboardVM_Dependency_4_FirstItemTemplate(UIContext context)
		: base(context)
	{
	}
