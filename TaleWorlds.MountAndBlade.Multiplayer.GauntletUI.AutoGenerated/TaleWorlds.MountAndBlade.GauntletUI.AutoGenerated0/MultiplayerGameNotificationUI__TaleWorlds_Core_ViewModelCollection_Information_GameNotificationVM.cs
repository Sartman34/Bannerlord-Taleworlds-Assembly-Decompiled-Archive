...
public class MultiplayerGameNotificationUI__TaleWorlds_Core_ViewModelCollection_Information_GameNotificationVM : Widget, IGeneratedGauntletMovieRoot
{
	...
	public MultiplayerGameNotificationUI__TaleWorlds_Core_ViewModelCollection_Information_GameNotificationVM(UIContext context)
		: base(context)
	{
	}
	...
	public void SetAttributes()
	{
		...
		_widget_0.MarginTop = 165f;
		_widget_0.Brush = base.Context.GetBrush("MultiplayerGameNotification");
		...
		_widget_0_0_0_0.Brush = base.Context.GetBrush("MultiplayerGameNotification.AnnouncerName.Text");
		...
		_widget_0_0_1.PositionYOffset = -4f;
		_widget_0_0_1.MarginRight = 60f;
		_widget_0_0_1.MarginTop = 15f;
		_widget_0_0_1.MarginBottom = 15f;
		_widget_0_0_1.Brush = base.Context.GetBrush("MultiplayerGameNotification.Text");
	}
