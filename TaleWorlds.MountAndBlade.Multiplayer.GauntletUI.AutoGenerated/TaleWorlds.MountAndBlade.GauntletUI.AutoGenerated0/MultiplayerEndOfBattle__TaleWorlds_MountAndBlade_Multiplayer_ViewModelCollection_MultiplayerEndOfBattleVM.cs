...
public class MultiplayerEndOfBattle__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_MultiplayerEndOfBattleVM : MultiplayerEndOfBattleScreenWidget, IGeneratedGauntletMovieRoot
{
	...
	public void CreateWidgets()
	{
		...
		_widget_2_0 = new MultiplayerEndOfBattle__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_MultiplayerEndOfBattleVM_Dependency_1_MultiplayerEndOfRound_MVP__DependendPrefab(base.Context);
		_widget_2.AddChild(_widget_2_0);
		_widget_2_0.CreateWidgets();
		_widget_3 = new Widget(base.Context);
		_widget.AddChild(_widget_3);
		_widget_3_0 = new MultiplayerEndOfBattle__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_MultiplayerEndOfBattleVM_Dependency_2_MultiplayerEndOfRound_MVP__DependendPrefab(base.Context);
		_widget_3.AddChild(_widget_3_0);
		_widget_3_0.CreateWidgets();
		_widget_4 = new Widget(base.Context);
		_widget.AddChild(_widget_4);
		_widget_4_0 = new MultiplayerEndOfBattle__TaleWorlds_MountAndBlade_Multiplayer_ViewModelCollection_MultiplayerEndOfBattleVM_Dependency_3_MultiplayerEndOfRound_MVP__DependendPrefab(base.Context);
