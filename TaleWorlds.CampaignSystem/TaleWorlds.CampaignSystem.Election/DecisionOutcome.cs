...
public abstract class DecisionOutcome
{
	...
	public float Support
	{
		...
		{
			float num = 0f;
			using List<Supporter>.Enumerator enumerator = SupporterList.GetEnumerator();
