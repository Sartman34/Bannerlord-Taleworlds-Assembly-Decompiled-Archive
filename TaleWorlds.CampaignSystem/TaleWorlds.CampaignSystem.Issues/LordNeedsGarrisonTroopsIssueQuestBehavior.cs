...
public class LordNeedsGarrisonTroopsIssueQuestBehavior : CampaignBehaviorBase
{
	public class LordNeedsGarrisonTroopsIssue : IssueBase
	{
		...
		protected override int RewardGold
		{
			get
			{
				int num = Campaign.Current.Models.PartyWageModel.GetTroopRecruitmentCost(_neededTroopType, Hero.MainHero) * NumberOfTroopToBeRecruited;
		...
		public override bool DoTroopsSatisfyAlternativeSolution(TroopRoster troopRoster, out TextObject explanation)
		{
			...
			return QuestHelper.CheckRosterForAlternativeSolution(troopRoster, GetTotalAlternativeSolutionNeededMenCount(), ref explanation, 0, mountedRequired: true);
		}
		...
		{
			explanation = TextObject.Empty;
			return QuestHelper.CheckRosterForAlternativeSolution(MobileParty.MainParty.MemberRoster, GetTotalAlternativeSolutionNeededMenCount(), ref explanation, 0, mountedRequired: true);
		}
	...
	public class LordNeedsGarrisonTroopsIssueQuest : QuestBase
	{
		...
		private TextObject _timeOutLogText => new TextObject("{=cnaxgN5b}You have failed to bring the troops in time.");
		...
		{
			StartQuest();
			_playerStartsQuestLog = AddDiscreteLog(_playerStartsQuestLogText, new TextObject("{=WIb9VvEM}Collected Troops"), _collectedTroopAmount, _requestedTroopAmount);
		}
		...
		private void OnSettlementOwnerChanged(Settlement settlement, bool openToClaim, Hero newOwner, Hero oldOwner, Hero capturerHero, ChangeOwnerOfSettlementAction.ChangeOwnerOfSettlementDetail detail)
		{
			...
			{
				AddLog(_questGiverLostTheSettlementLogText);
		...
		private void OnClanChangedKingdom(Clan clan, Kingdom oldKingdom, Kingdom newKingdom, ChangeKingdomAction.ChangeKingdomActionDetail detail, bool showNotification = true)
		{
			...
			{
				CompleteQuestWithCancel(_questFailedWarDeclaredLogText);
			}
		}

		private void OnWarDeclared(IFaction faction1, IFaction faction2, DeclareWarAction.DeclareWarDetail detail)
		{
			QuestHelper.CheckWarDeclarationAndFailOrCancelTheQuest(this, faction1, faction2, detail, _playerDeclaredWarQuestLogText, _questFailedWarDeclaredLogText);
		}
