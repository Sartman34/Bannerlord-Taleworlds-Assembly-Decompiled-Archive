...
public static class AlleyHelper
{
	...
	{
		PartyScreenManager.OpenScreenForManagingAlley(leftMemberRoster, IsTroopTransferable, DoneButtonCondition, onDoneButtonClicked, leftText, onCancelButtonClicked);
	}
