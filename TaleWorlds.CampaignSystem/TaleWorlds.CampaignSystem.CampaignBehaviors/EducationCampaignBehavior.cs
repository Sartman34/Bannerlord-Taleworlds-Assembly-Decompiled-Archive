...
public class EducationCampaignBehavior : CampaignBehaviorBase, IEducationLogic
{
	...
	private EducationStage CreateStage2(Hero child)
	{
		...
		{
			EducationCharacterProperties childProperties2 = dictionary2[maxAttributes[i].Item1];
			educationPage.AddOption(new EducationOption(maxAttributes[i].Item1.Name, dictionary[maxAttributes[i].Item1], null, null, null, new CharacterAttribute[1] { maxAttributes[i].Item1 }, null, childProperties2));
		}
		...
		{
			EducationCharacterProperties childProperties4 = dictionary2[maxAttributes2[j].Item1];
			educationPage2.AddOption(new EducationOption(maxAttributes2[j].Item1.Name, dictionary[maxAttributes2[j].Item1], null, null, null, new CharacterAttribute[1] { maxAttributes2[j].Item1 }, null, childProperties4));
		}
		...
		for (int k = 0; k < Attributes.All.Count; k++)
		{
			...
			EducationCharacterProperties childProperties5 = dictionary2[attributeOne];
			...
			for (int l = 0; l < Attributes.All.Count - 1; l++)
			{
				...
				EducationOption.EducationOptionConditionDelegate condition = delegate(EducationOption o, List<EducationOption> previousOptions)
				{
					...
					bool num2 = previousOptions[0].Attributes.Contains(attributeOne) || previousOptions[1].Attributes.Contains(attributeOne) || previousOptions[0].Attributes.Contains(attributeTwo) || previousOptions[1].Attributes.Contains(attributeTwo);
					int num3 = (Attributes.All.Count - num - 1) * (Attributes.All.Count - num);
					int randomValue = previousOptions[0].RandomValue;
					int randomValue2 = previousOptions[1].RandomValue;
					int num4 = (randomValue % num3 + randomValue2 % num3) % num3;
					if (!num2)
					{
						int num5 = optionIndexer;
						optionIndexer = num5 + 1;
					}
					if (!num2 && num4 == optionIndexer % num3)
					{
				...
				stage_0_page_2.AddOption(new EducationOption(textObject3, textObject4, null, condition, null, new CharacterAttribute[2] { attributeOne, attributeTwo }, null, childProperties5));
			}
		}
	...
	private EducationStage CreateStage5(Hero child)
	{
		...
		{
			int index = j;
			EducationCharacterProperties childProperties2 = array2[index];
	...
	private EducationStage CreateStage8(Hero child)
	{
		...
		EducationCharacterProperties childProperties2 = new EducationCharacterProperties("act_childhood_arms_2", "training_sword", useOffHand: false);
		EducationCharacterProperties specialCharacterProperties = new EducationCharacterProperties("act_childhood_closed_tutor");
		EducationCharacterProperties childProperties3 = new EducationCharacterProperties("act_childhood_manners");
		EducationCharacterProperties specialCharacterProperties2 = new EducationCharacterProperties("act_childhood_confident2_tutor");
		EducationCharacterProperties childProperties4 = new EducationCharacterProperties("act_childhood_artisan", "carry_linen", useOffHand: false);
		EducationCharacterProperties specialCharacterProperties3 = new EducationCharacterProperties("act_childhood_confident_tutor");
		EducationCharacterProperties childProperties5 = new EducationCharacterProperties("act_childhood_book", "character_creation_notebook", useOffHand: true);
		EducationCharacterProperties specialCharacterProperties4 = new EducationCharacterProperties("act_childhood_demure_tutor");
		EducationCharacterProperties childProperties6 = new EducationCharacterProperties("act_childhood_ready_bow", "bow_roman_a", useOffHand: true);
		EducationCharacterProperties specialCharacterProperties5 = new EducationCharacterProperties("act_childhood_hip_tutor");
		EducationCharacterProperties childProperties7 = new EducationCharacterProperties("act_childhood_leader");
		...
		EducationOption stage_2_page_0_option_masterAtArms = new EducationOption(title2, textObject3, null, null, null, new CharacterAttribute[1] { DefaultCharacterAttributes.Vigor }, null, childProperties2, specialCharacterProperties);
		EducationOption stage_2_page_0_option_steward = new EducationOption(title3, textObject4, null, null, null, new CharacterAttribute[1] { DefaultCharacterAttributes.Social }, null, childProperties3, specialCharacterProperties2);
		EducationOption stage_2_page_0_option_artisan = new EducationOption(title4, textObject5, null, null, null, new CharacterAttribute[1] { DefaultCharacterAttributes.Endurance }, null, childProperties4, specialCharacterProperties3);
		EducationOption stage_2_page_0_option_intelligence = new EducationOption(textObject, textObject8, null, null, null, new CharacterAttribute[1] { DefaultCharacterAttributes.Intelligence }, null, childProperties5, specialCharacterProperties4);
		EducationOption stage_2_page_0_option_huntsman = new EducationOption(title5, description2, null, null, null, new CharacterAttribute[1] { DefaultCharacterAttributes.Control }, null, childProperties6, specialCharacterProperties5);
		EducationOption stage_2_page_0_option_cunning = new EducationOption(textObject2, textObject9, null, null, null, new CharacterAttribute[1] { DefaultCharacterAttributes.Cunning }, null, childProperties7, specialCharacterProperties6);
		...
		EducationCharacterProperties childProperties9 = new EducationCharacterProperties("act_childhood_guard_up_staff", "carry_bostaff", useOffHand: false);
		EducationCharacterProperties childProperties10 = new EducationCharacterProperties("act_childhood_focus", "training_sword", useOffHand: false);
		EducationCharacterProperties childProperties11 = new EducationCharacterProperties("act_childhood_fierce");
		EducationCharacterProperties childProperties12 = new EducationCharacterProperties("act_childhood_arms_2", "training_sword", useOffHand: false);
		EducationCharacterProperties childProperties13 = new EducationCharacterProperties("act_childhood_ready_bow", "bow_roman_a", useOffHand: true);
		...
		educationPage2.AddOption(new EducationOption(DefaultSkills.Riding.Name, new TextObject("{=K08ed2LS}You asked your master-at-arms to make sure that as a noble, this {?CHILD.GENDER}daughter{?}son{\\?} of the clan knows how to hold {?CHILD.GENDER}herself{?}himself{\\?} properly on the saddle."), null, null, null, null, new SkillObject[1] { DefaultSkills.Riding }, childProperties8, specialCharacterProperties7));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Polearm.Name, new TextObject("{=LE0NCSPP}Every warrior needs to know the basics. Polearms are used by warriors of all classes, from feudal levies and urban militias to elite lancers."), null, null, null, null, new SkillObject[1] { DefaultSkills.Polearm }, childProperties9, specialCharacterProperties8));
		educationPage2.AddOption(new EducationOption(DefaultSkills.OneHanded.Name, new TextObject("{=PpuRM82X}The sword is the weapon of the noble warrior. It is useful both in the battlefield and in court, where it symbolizes a wearer's willingness to fight to protect {?CHILD.GENDER}her{?}his{\\?} honor."), null, null, null, null, new SkillObject[1] { DefaultSkills.OneHanded }, childProperties10, specialCharacterProperties9));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Athletics.Name, new TextObject("{=C5UrdSgj}Fast legs and stamina are as vital to a warrior's survival as {?CHILD.GENDER}her{?}his{\\?} strength and skill."), null, null, null, null, new SkillObject[1] { DefaultSkills.Athletics }, childProperties11, specialCharacterProperties10));
		educationPage2.AddOption(new EducationOption(DefaultSkills.TwoHanded.Name, new TextObject("{=Adah5bay}The most powerful weapons require years of practice and conditioning to use properly. Their wielders need to start early."), null, null, null, null, new SkillObject[1] { DefaultSkills.TwoHanded }, childProperties12, specialCharacterProperties11));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Bow.Name, new TextObject("{=QakanPLW}It will be years before the child can develop the strength, breathing techniques, and patience needed to wield a powerful bow, but it never hurts to start early."), null, null, null, null, new SkillObject[1] { DefaultSkills.Bow }, childProperties13, specialCharacterProperties12));
		...
		EducationCharacterProperties childProperties14 = new EducationCharacterProperties("act_childhood_numbers");
		EducationCharacterProperties childProperties15 = new EducationCharacterProperties("act_childhood_memory");
		EducationCharacterProperties childProperties16 = new EducationCharacterProperties("act_childhood_manners_3");
		EducationCharacterProperties childProperties17 = new EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", useOffHand: true);
		EducationCharacterProperties childProperties18 = new EducationCharacterProperties("act_childhood_leader");
		EducationCharacterProperties childProperties19 = new EducationCharacterProperties("act_childhood_decisive");
		...
		educationPage3.AddOption(new EducationOption(DefaultSkills.Steward.Name, new TextObject("{=XsQ5rabf}The first thing that a steward must know is to how to count add numbers together. "), null, null, null, null, new SkillObject[1] { DefaultSkills.Steward }, childProperties14, specialCharacterProperties13));
		...
		educationPage3.AddOption(new EducationOption(DefaultSkills.Charm.Name, new TextObject("{=pHmz4GZN}Everything is easier when people are pleased by your presence. Proper grace and etiquette will be useful even among enemies."), null, null, null, null, new SkillObject[1] { DefaultSkills.Charm }, childProperties16, specialCharacterProperties15));
		educationPage3.AddOption(new EducationOption(DefaultSkills.Riding.Name, new TextObject("{=hB72eE6b}Horses are among your clan's most valuable assets, so you encouraged your steward to take the child along on his frequent inspections of the stables."), null, null, null, null, new SkillObject[1] { DefaultSkills.Riding }, childProperties17, specialCharacterProperties16));
		educationPage3.AddOption(new EducationOption(DefaultSkills.Leadership.Name, new TextObject("{=N1WyvVHY}You instructed the child to pay close attention to how the steward exerts authority."), null, null, null, null, new SkillObject[1] { DefaultSkills.Leadership }, childProperties18, specialCharacterProperties17));
		...
		EducationCharacterProperties childProperties20 = new EducationCharacterProperties("act_childhood_grit", "carry_hammer", useOffHand: false);
		EducationCharacterProperties childProperties21 = new EducationCharacterProperties("act_childhood_memory");
		EducationCharacterProperties childProperties22 = new EducationCharacterProperties("act_childhood_arms", "training_sword", useOffHand: false);
		EducationCharacterProperties childProperties23 = new EducationCharacterProperties("act_childhood_ready", "carry_book_left", useOffHand: true);
		EducationCharacterProperties childProperties24 = new EducationCharacterProperties("act_childhood_manners");
		EducationCharacterProperties childProperties25 = new EducationCharacterProperties("act_childhood_militia", "carry_hammer", useOffHand: false);
		...
		educationPage4.AddOption(new EducationOption(DefaultSkills.Crafting.Name, new TextObject("{=bx6Jhhui}The artisan should make sure that the child knows the basics of smithing, fletching and pole-turning, and that men who work with their hands take pride in their work."), null, null, null, null, new SkillObject[1] { DefaultSkills.Crafting }, childProperties20, specialCharacterProperties19));
		educationPage4.AddOption(new EducationOption(DefaultSkills.Trade.Name, new TextObject("{=xHstOUBx}You made sure your artisan taught this child to recognize quality work, as well as its worth in denars."), null, null, null, null, new SkillObject[1] { DefaultSkills.Trade }, childProperties21, specialCharacterProperties20));
		educationPage4.AddOption(new EducationOption(DefaultSkills.OneHanded.Name, new TextObject("{=Ir7BP5bD}The best smiths are those that understand how their tools are used. Your child will be tasked with sparring with the weapons and testing their edges. "), null, null, null, null, new SkillObject[1] { DefaultSkills.OneHanded }, childProperties22, specialCharacterProperties21));
		educationPage4.AddOption(new EducationOption(DefaultSkills.Engineering.Name, new TextObject("{=N0eHkPV2}A craftsman makes parts and an engineer fits them together. The best artisans learn to do both."), null, null, null, null, new SkillObject[1] { DefaultSkills.Engineering }, childProperties23, specialCharacterProperties22));
		educationPage4.AddOption(new EducationOption(DefaultSkills.Steward.Name, new TextObject("{=tyzzUNN7}You instructed the artisan to teach your the child the basics of managing a workshop."), null, null, null, null, new SkillObject[1] { DefaultSkills.Steward }, childProperties24, specialCharacterProperties23));
		educationPage4.AddOption(new EducationOption(DefaultSkills.Athletics.Name, new TextObject("{=biqBLGwa}You told the artisan to make sure that {?PLAYER_CHILD}your{?}the{\\?} child works hard, and that {?CHILD.GENDER}she{?}he{\\?} swings the hammer for hours in the blazing heat of the forge. It tempers the soul, you believe."), null, null, null, null, new SkillObject[1] { DefaultSkills.Athletics }, childProperties25, specialCharacterProperties24));
		...
		EducationCharacterProperties childProperties30 = new EducationCharacterProperties("act_childhood_appearances");
		EducationCharacterProperties childProperties31 = new EducationCharacterProperties("act_childhood_tactician");
		...
		educationPage5.AddOption(new EducationOption(DefaultSkills.Medicine.Name, new TextObject("{=5pGCtBhd}You asked that your child be schooled over the next few years in all the treatises that can be found on human body, its ailments, and their treatments."), null, null, null, null, new SkillObject[1] { DefaultSkills.Medicine }, childProperties26, specialCharacterProperties25));
		educationPage5.AddOption(new EducationOption(DefaultSkills.Engineering.Name, new TextObject("{=CtImGA4A}Most tutors teach mathematics from tracing the path of stars in the sky, but you wanted your {?IS_BATTANIA_OR_KHUZAIT}lorekeeper{?}scholar{\\?} to focus on the more practical architectural treatises."), null, null, null, null, new SkillObject[1] { DefaultSkills.Engineering }, childProperties27, specialCharacterProperties26));
		educationPage5.AddOption(new EducationOption(DefaultSkills.Leadership.Name, new TextObject("{=Nn8bmGUX}You make sure that the child would be taught the deeds of the leaders of your people, and memorize the rhetoric they used to inspire their followers."), null, null, null, null, new SkillObject[1] { DefaultSkills.Leadership }, childProperties28, specialCharacterProperties27));
		educationPage5.AddOption(new EducationOption(DefaultSkills.Charm.Name, new TextObject("{=MgPubWOa}The epics are full of men and women who preferred words to the sword, and who could win the friendship of allies and the admiration of enemies."), null, null, null, null, new SkillObject[1] { DefaultSkills.Charm }, childProperties29, specialCharacterProperties28));
		educationPage5.AddOption(new EducationOption(DefaultSkills.Steward.Name, new TextObject("{=c4NPLD0S}Any child of a noble clan needs to know how some kings and emperors accumulated wealth and how others squandered it."), null, null, null, null, new SkillObject[1] { DefaultSkills.Steward }, childProperties30, specialCharacterProperties29));
		educationPage5.AddOption(new EducationOption(DefaultSkills.Tactics.Name, new TextObject("{=3iED3Ca9}To craft a tactic one must first have an idea of what has worked in the past and what has failed, and any commander should know the course and outcome of as many battles as possible."), null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties31, specialCharacterProperties30));
		...
		educationPage6.AddOption(new EducationOption(DefaultSkills.Scouting.Name, new TextObject("{=lbHswWdb}Hunting is all about being aware of your surroundings and tracking your prey. You felt that the same skills would serve a lord well in journeys across the wild."), null, null, null, null, new SkillObject[1] { DefaultSkills.Scouting }, childProperties32, specialCharacterProperties31));
		educationPage6.AddOption(new EducationOption(DefaultSkills.Bow.Name, new TextObject("{=ItS9F61H}You told {CHILD.NAME} that any young noble worth {?CHILD.GENDER}her{?}his{\\?} salt should be able to bring down a deer from fifty paces away, or hit a rabbit on the run."), null, null, null, null, new SkillObject[1] { DefaultSkills.Bow }, childProperties33, specialCharacterProperties32));
		educationPage6.AddOption(new EducationOption(DefaultSkills.Polearm.Name, new TextObject("{=bZlhwK0a}Bows are all very well for small game, but those who pursue bears, boar or wolves bring spears along."), null, null, null, null, new SkillObject[1] { DefaultSkills.Polearm }, childProperties34, specialCharacterProperties33));
		educationPage6.AddOption(new EducationOption(DefaultSkills.Medicine.Name, new TextObject("{=rPP0OSBm}Treating sprained ankles, broken bones and lamed horses are as much a part of a hunting expedition as skinning and gutting your quarry."), null, null, null, null, new SkillObject[1] { DefaultSkills.Medicine }, childProperties35, specialCharacterProperties34));
		educationPage6.AddOption(new EducationOption(DefaultSkills.Athletics.Name, new TextObject("{=EbRDo6Lv}A hunter should be able to endure long treks over rough ground and pursue a wounded quarry until it drops."), null, null, null, null, new SkillObject[1] { DefaultSkills.Athletics }, childProperties36, specialCharacterProperties35));
		educationPage6.AddOption(new EducationOption(DefaultSkills.Tactics.Name, new TextObject("{=b9nvCgYF}A hunter knows how to prepare a trap and how to draw a prey to it, and, when dangerous predators are about, how to avoid becoming the hunted."), null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties37, specialCharacterProperties36));
		...
		Stage2Selection(skills, educationPage2, currentPage, childProperties44, tutorProperties);
		...
		Stage2Selection(skills2, educationPage3, currentPage2, childProperties45, tutorProperties2);
		...
		Stage2Selection(skills3, educationPage4, currentPage3, childProperties46, tutorProperties3);
		...
		Stage2Selection(skills4, educationPage5, educationPage8, childProperties47, tutorProperties4);
		...
		Stage2Selection(skills5, educationPage6, currentPage4, childProperties48, tutorProperties5);
		...
		Stage2Selection(skills6, educationPage7, educationPage9, childProperties49, tutorProperties6);
	...
	private EducationStage CreateStage11(Hero child)
	{
		...
		EducationCharacterProperties childProperties9 = new EducationCharacterProperties("act_childhood_tactician");
		EducationCharacterProperties childProperties10 = new EducationCharacterProperties("act_childhood_manners");
		EducationCharacterProperties childProperties11 = new EducationCharacterProperties("act_childhood_grit", "carry_hammer", useOffHand: false);
		EducationCharacterProperties childProperties12 = new EducationCharacterProperties("act_childhood_leader_2");
		EducationCharacterProperties childProperties13 = new EducationCharacterProperties("act_childhood_genius");
		educationPage2.AddOption(new EducationOption(DefaultSkills.Polearm.Name, new TextObject("{=3lDTSlpU}Even the most skilled swordsman or the strongest axe-wielder is to a lancer as the rabbit is to the eagle."), null, null, null, null, new SkillObject[1] { DefaultSkills.Polearm }, childProperties8));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Tactics.Name, new TextObject("{=2s6cH2kE}Even the finest swordsman can perish if his lord is ignorant of the difference between necessary risks and reckless, unnecessary ones."), null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties9));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Steward.Name, new TextObject("{=ePNba38W}Armies win battles, but farms and towns win wars."), null, null, null, null, new SkillObject[1] { DefaultSkills.Steward }, childProperties10));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Engineering.Name, new TextObject("{=bnPgkPv2}Towers, domes and gates are wonders that we must never take for granted."), null, null, null, null, new SkillObject[1] { DefaultSkills.Engineering }, childProperties11));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Leadership.Name, new TextObject("{=jqstr7ZL}Learn to fire men's pride, stoke their anger and dispel their fears, and they will turn from men into lions who will do anything for you."), null, null, null, null, new SkillObject[1] { DefaultSkills.Leadership }, childProperties12));
		educationPage2.AddOption(new EducationOption(DefaultSkills.Trade.Name, new TextObject("{=T3vJp4PG}Whoever grasps how prices work can pluck silver out of thin air."), null, null, null, null, new SkillObject[1] { DefaultSkills.Trade }, childProperties13));
		...
		{
			int index = j;
			EducationCharacterProperties childProperties14 = array2[index];
			...
			stage_3_page_2.AddOption(new EducationOption(optionTitle, item, null, condition, null, null, new SkillObject[1] { item2 }, childProperties14));
		}
		return educationStage;
	}
	...
	private EducationStage CreateStage14(Hero child)
	{
		...
		EducationCharacterProperties childProperties2 = new EducationCharacterProperties("act_childhood_arms", "vlandia_twohanded_sword_c", useOffHand: false);
		EducationCharacterProperties childProperties3 = new EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", useOffHand: true);
		EducationCharacterProperties childProperties4 = new EducationCharacterProperties("act_childhood_clever_2", "carry_scroll", useOffHand: false);
		EducationCharacterProperties childProperties5 = new EducationCharacterProperties("act_childhood_sharp", "carry_game_left", useOffHand: true);
		EducationCharacterProperties childProperties6 = new EducationCharacterProperties("act_childhood_ready_bow", "bow_roman_a", useOffHand: true);
		EducationCharacterProperties childProperties7 = new EducationCharacterProperties("act_childhood_appearances");
		...
		educationPage2.AddOption(new EducationOption(new TextObject("{=bX841Jau}learn the arts of healing."), new TextObject("{=3hFT34l1}{?PLAYER_CHILD}Your{?}The{\\?} child helps out the local physician, binding and cleaning wounds and, when the master is absent, prescribing remedies."), null, null, null, null, new SkillObject[1] { DefaultSkills.Medicine }, childProperties11));
		educationPage2.AddOption(new EducationOption(new TextObject("{=ltbU06Fi}become a crack shot."), new TextObject("{=7JoiyH1Y}You heard that {CHILD.NAME} could put an arrow through an arm ring from 100 paces away, but you didn't believe it until you saw it."), null, null, null, null, new SkillObject[1] { DefaultSkills.Bow }, childProperties12));
		...
		{
			int index = i;
			EducationCharacterProperties childProperties14 = array[index];
			...
			educationPage3.AddOption(new EducationOption(optionTitle, item, null, condition, null, null, skills, childProperties14));
		}
		return educationStage;
	}
	...
	private EducationStage CreateStage16(Hero child)
	{
		...
		EducationCharacterProperties childProperties2 = new EducationCharacterProperties("act_childhood_apprentice", "vlandia_twohanded_sword_c", useOffHand: false);
		...
		EducationCharacterProperties childProperties8 = new EducationCharacterProperties("act_childhood_fierce", "vlandia_twohanded_sword_c", useOffHand: false);
		EducationCharacterProperties childProperties9 = new EducationCharacterProperties("act_childhood_guard_up_staff", "carry_bostaff", useOffHand: false);
		EducationCharacterProperties childProperties10 = new EducationCharacterProperties("act_childhood_militia", "vlandia_twohanded_sword_c", useOffHand: false);
		EducationCharacterProperties childProperties11 = new EducationCharacterProperties("act_childhood_leader_2");
		EducationCharacterProperties childProperties12 = new EducationCharacterProperties("act_childhood_arms_2", "vlandia_twohanded_sword_c", useOffHand: false);
		EducationCharacterProperties childProperties13 = new EducationCharacterProperties("act_childhood_tactician");
		educationPage2.AddOption(new EducationOption(new TextObject("{=6LpwsxYP}gets bloodied."), textObject2, null, null, null, null, new SkillObject[1] { DefaultSkills.OneHanded }, childProperties8));
		educationPage2.AddOption(new EducationOption(new TextObject("{=hes54oh0}joins in a tournament."), textObject3, null, null, null, null, new SkillObject[1] { DefaultSkills.Polearm }, childProperties9));
		educationPage2.AddOption(new EducationOption(new TextObject("{=z50GdIa3}learns to inspire the soldiers."), textObject4, null, null, null, null, new SkillObject[1] { DefaultSkills.Charm }, childProperties10));
		educationPage2.AddOption(new EducationOption(new TextObject("{=MpdPpIEY}leads a patrol."), textObject5, null, null, null, null, new SkillObject[1] { DefaultSkills.Leadership }, childProperties11));
		educationPage2.AddOption(new EducationOption(new TextObject("{=flCA80Ex}trains really hard."), textObject6, null, null, null, null, new SkillObject[1] { DefaultSkills.TwoHanded }, childProperties12));
		educationPage2.AddOption(new EducationOption(new TextObject("{=UuQDXIFD}hunts down bandits."), textObject7, null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties13));
		...
		educationPage3.AddOption(new EducationOption(new TextObject("{=QVZMiaV2}helping recover stolen goods."), textObject9, null, null, null, null, new SkillObject[1] { DefaultSkills.Roguery }, childProperties15));
		educationPage3.AddOption(new EducationOption(new TextObject("{=hfaw7Xx9}helping the artisan."), textObject10, null, null, null, null, new SkillObject[1] { DefaultSkills.Crafting }, childProperties16));
		educationPage3.AddOption(new EducationOption(new TextObject("{=XYRZIPD8}guiding the caravan."), textObject11, null, null, null, null, new SkillObject[1] { DefaultSkills.Scouting }, childProperties17));
		educationPage3.AddOption(new EducationOption(new TextObject("{=JX13Wd65}managing the logistics of travel."), textObject12, null, null, null, null, new SkillObject[1] { DefaultSkills.Steward }, childProperties18));
		educationPage3.AddOption(new EducationOption(new TextObject("{=rvqVuM5o}supervising the guards."), textObject13, null, null, null, null, new SkillObject[1] { DefaultSkills.Leadership }, childProperties19));
		...
		EducationCharacterProperties childProperties20 = new EducationCharacterProperties("act_childhood_ready", "carry_book_left", useOffHand: true);
		EducationCharacterProperties childProperties21 = new EducationCharacterProperties("act_childhood_gracious", "carry_book", useOffHand: false);
		EducationCharacterProperties childProperties22 = new EducationCharacterProperties("act_childhood_grit", "carry_hammer", useOffHand: false);
		EducationCharacterProperties childProperties23 = new EducationCharacterProperties("act_childhood_peddlers_2", "carry_sticks", useOffHand: false);
		EducationCharacterProperties childProperties24 = new EducationCharacterProperties("act_childhood_tactician");
		EducationCharacterProperties childProperties25 = new EducationCharacterProperties("act_childhood_manners");
		educationPage4.AddOption(new EducationOption(new TextObject("{=L1o5mb69}learns to construct siege engines."), textObject14, null, null, null, null, new SkillObject[1] { DefaultSkills.Engineering }, childProperties20));
		educationPage4.AddOption(new EducationOption(new TextObject("{=74pYaU18}treats injuries."), textObject15, null, null, null, null, new SkillObject[1] { DefaultSkills.Medicine }, childProperties21));
		educationPage4.AddOption(new EducationOption(new TextObject("{=vsFVlFa4}assists the smiths."), textObject16, null, null, null, null, new SkillObject[1] { DefaultSkills.Crafting }, childProperties22));
		educationPage4.AddOption(new EducationOption(new TextObject("{=jL8ntljn}procures supplies."), textObject17, null, null, null, null, new SkillObject[1] { DefaultSkills.Trade }, childProperties23));
		educationPage4.AddOption(new EducationOption(new TextObject("{=I6oqLFXh}focuses on the big picture."), textObject18, null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties24));
		educationPage4.AddOption(new EducationOption(new TextObject("{=XTmpkNNg}socializes with other engineers."), textObject19, null, null, null, null, new SkillObject[1] { DefaultSkills.Charm }, childProperties25));
		...
		EducationCharacterProperties childProperties26 = new EducationCharacterProperties("act_childhood_athlete");
		EducationCharacterProperties childProperties27 = new EducationCharacterProperties("act_childhood_ready_bow", "bow_roman_a", useOffHand: true);
		EducationCharacterProperties childProperties28 = new EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", useOffHand: true);
		EducationCharacterProperties childProperties29 = new EducationCharacterProperties("act_childhood_tactician");
		EducationCharacterProperties childProperties30 = new EducationCharacterProperties("act_childhood_leader_2");
		EducationCharacterProperties childProperties31 = new EducationCharacterProperties("act_childhood_fierce");
		educationPage5.AddOption(new EducationOption(new TextObject("{=AWuEV99O}unleashes {?CHILD.GENDER}her{?}his{\\?} fighting spirit."), textObject20, null, null, null, null, new SkillObject[1] { DefaultSkills.Athletics }, childProperties26));
		educationPage5.AddOption(new EducationOption(new TextObject("{=Mk6dZBQa}skirmishes from a distance."), textObject21, null, null, null, null, new SkillObject[1] { DefaultSkills.Bow }, childProperties27));
		educationPage5.AddOption(new EducationOption(new TextObject("{=Mp7dT2u2}chases and is chased."), textObject22, null, null, null, null, new SkillObject[1] { DefaultSkills.Riding }, childProperties28));
		educationPage5.AddOption(new EducationOption(new TextObject("{=4pOb934Y}understands how a victory is won."), textObject23, null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties29));
		educationPage5.AddOption(new EducationOption(new TextObject("{=eXLxHSls}leads men into enemy territory."), textObject24, null, null, null, null, new SkillObject[1] { DefaultSkills.Leadership }, childProperties30));
		educationPage5.AddOption(new EducationOption(new TextObject("{=1BFk0wAV}defeats an enemy."), textObject25, null, null, null, null, new SkillObject[1] { DefaultSkills.OneHanded }, childProperties31));
		...
		EducationCharacterProperties childProperties32 = new EducationCharacterProperties("act_childhood_roguery", "carry_bostaff_rogue1", useOffHand: false);
		EducationCharacterProperties childProperties33 = new EducationCharacterProperties("act_childhood_streets", "carry_bostaff_rogue1", useOffHand: false);
		EducationCharacterProperties childProperties34 = new EducationCharacterProperties("act_childhood_guard_up_staff", "carry_bostaff", useOffHand: false);
		EducationCharacterProperties childProperties35 = new EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", useOffHand: true);
		EducationCharacterProperties childProperties36 = new EducationCharacterProperties("act_childhood_appearances");
		EducationCharacterProperties childProperties37 = new EducationCharacterProperties("act_childhood_strenght", "carry_sticks", useOffHand: false);
		educationPage6.AddOption(new EducationOption(new TextObject("{=1LWWvGTT}participate in a pilgrimage."), textObject26, null, null, null, null, new SkillObject[1] { DefaultSkills.Athletics }, childProperties32));
		educationPage6.AddOption(new EducationOption(new TextObject("{=8alDLq0s}not to be too choosy about travelling companions."), textObject27, null, null, null, null, new SkillObject[1] { DefaultSkills.Roguery }, childProperties33));
		educationPage6.AddOption(new EducationOption(new TextObject("{=RxqCiO7F}competes in tournaments."), textObject28, null, null, null, null, new SkillObject[1] { DefaultSkills.Polearm }, childProperties34));
		educationPage6.AddOption(new EducationOption(new TextObject("{=ETfx08db}see as much of the world as {?CHILD.GENDER}she{?}he{\\?} could."), textObject29, null, null, null, null, new SkillObject[1] { DefaultSkills.Riding }, childProperties35));
		educationPage6.AddOption(new EducationOption(new TextObject("{=RhJdnAQY}enjoy the high life."), textObject30, null, null, null, null, new SkillObject[1] { DefaultSkills.Charm }, childProperties36));
		educationPage6.AddOption(new EducationOption(new TextObject("{=dObod6IZ}do some honest work."), textObject31, null, null, null, null, new SkillObject[1] { DefaultSkills.Crafting }, childProperties37));
		...
		EducationCharacterProperties childProperties38 = new EducationCharacterProperties("act_childhood_ready", "carry_book_left", useOffHand: true);
		EducationCharacterProperties childProperties39 = new EducationCharacterProperties("act_childhood_hardened");
		EducationCharacterProperties childProperties40 = new EducationCharacterProperties("act_childhood_manners");
		EducationCharacterProperties childProperties41 = new EducationCharacterProperties("act_childhood_apprentice", "training_sword", useOffHand: false);
		EducationCharacterProperties childProperties42 = new EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", useOffHand: true);
		EducationCharacterProperties childProperties43 = new EducationCharacterProperties("act_childhood_tactician");
		educationPage7.AddOption(new EducationOption(new TextObject("{=6jgjJ3Ts}help anyone in need."), textObject32, null, null, null, null, new SkillObject[1] { DefaultSkills.Medicine }, childProperties38));
		educationPage7.AddOption(new EducationOption(new TextObject("{=FfZpLoVD}dabble in intrigue."), textObject33, null, null, null, null, new SkillObject[1] { DefaultSkills.Roguery }, childProperties39));
		educationPage7.AddOption(new EducationOption(new TextObject("{=EzbzOsJo}burnish {?CHILD.GENDER}her{?}his{\\?} social skills."), textObject34, null, null, null, null, new SkillObject[1] { DefaultSkills.Charm }, childProperties40));
		educationPage7.AddOption(new EducationOption(new TextObject("{=bdYtcgyB}never back down from a challenge."), textObject35, null, null, null, null, new SkillObject[1] { DefaultSkills.OneHanded }, childProperties41));
		educationPage7.AddOption(new EducationOption(new TextObject("{=hrlBxgzs}enjoy the pleasures of the hunt."), textObject36, null, null, null, null, new SkillObject[1] { DefaultSkills.Riding }, childProperties42));
		educationPage7.AddOption(new EducationOption(new TextObject("{=XMaeSoRq}never let down {?CHILD.GENDER}her{?}his{\\?} guard."), textObject37, null, null, null, null, new SkillObject[1] { DefaultSkills.Tactics }, childProperties43));
		...
		for (int i = 0; i < array.Length; i++)
		{
			foreach (EducationOption option in array[i].Options)
			{
				option.Description.SetTextVariable("PLAYER_CHILD", IsHeroChildOfPlayer(child) ? 1 : 0);
			}
		}
		...
		Stage16Selection(titleDescSkillTuple, currentPage, childProperties44);
		...
		Stage16Selection(titleDescSkillTuple2, currentPage2, childProperties45);
		...
		Stage16Selection(titleDescSkillTuple3, currentPage3, childProperties46);
		...
		Stage16Selection(titleDescSkillTuple4, currentPage4, childProperties47);
		...
		Stage16Selection(titleDescSkillTuple5, currentPage5, childProperties48);
		...
		Stage16Selection(titleDescSkillTuple6, currentPage6, childProperties49);
		return educationStage;
	}
