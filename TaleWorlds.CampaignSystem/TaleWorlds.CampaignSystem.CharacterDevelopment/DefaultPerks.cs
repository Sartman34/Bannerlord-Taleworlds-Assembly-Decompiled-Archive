...
public class DefaultPerks
{
	...
	{
		public static PerkObject WrappedHandles => Instance._oneHandedWrappedHandles;

		public static PerkObject Basher => Instance._oneHandedBasher;

		public static PerkObject ToBeBlunt => Instance._oneHandedToBeBlunt;

		public static PerkObject SwiftStrike => Instance._oneHandedSwiftStrike;

		public static PerkObject Cavalry => Instance._oneHandedCavalry;

		public static PerkObject ShieldBearer => Instance._oneHandedShieldBearer;

		public static PerkObject Trainer => Instance._oneHandedTrainer;

		public static PerkObject Duelist => Instance._oneHandedDuelist;

		public static PerkObject ShieldWall => Instance._oneHandedShieldWall;

		public static PerkObject ArrowCatcher => Instance._oneHandedArrowCatcher;

		public static PerkObject MilitaryTradition => Instance._oneHandedMilitaryTradition;

		public static PerkObject CorpsACorps => Instance._oneHandedCorpsACorps;

		public static PerkObject StandUnited => Instance._oneHandedStandUnited;

		public static PerkObject LeadByExample => Instance._oneHandedLeadByExample;

		public static PerkObject SteelCoreShields => Instance._oneHandedSteelCoreShields;

		public static PerkObject FleetOfFoot => Instance._oneHandedFleetOfFoot;

		public static PerkObject DeadlyPurpose => Instance._oneHandedDeadlyPurpose;

		public static PerkObject UnwaveringDefense => Instance._oneHandedUnwaveringDefense;

		public static PerkObject Prestige => Instance._oneHandedPrestige;

		public static PerkObject WayOfTheSword => Instance._oneHandedWayOfTheSword;

		public static PerkObject ChinkInTheArmor => Instance._oneHandedChinkInTheArmor;
	}

	public static class TwoHanded
	{
		public static PerkObject StrongGrip => Instance._twoHandedStrongGrip;

		public static PerkObject WoodChopper => Instance._twoHandedWoodChopper;

		public static PerkObject OnTheEdge => Instance._twoHandedOnTheEdge;

		public static PerkObject HeadBasher => Instance._twoHandedHeadBasher;

		public static PerkObject ShowOfStrength => Instance._twoHandedShowOfStrength;

		public static PerkObject BaptisedInBlood => Instance._twoHandedBaptisedInBlood;

		public static PerkObject BeastSlayer => Instance._twoHandedBeastSlayer;

		public static PerkObject ShieldBreaker => Instance._twoHandedShieldBreaker;

		public static PerkObject Confidence => Instance._twoHandedConfidence;

		public static PerkObject Berserker => Instance._twoHandedBerserker;

		public static PerkObject ProjectileDeflection => Instance._twoHandedProjectileDeflection;

		public static PerkObject Terror => Instance._twoHandedTerror;

		public static PerkObject Hope => Instance._twoHandedHope;

		public static PerkObject RecklessCharge => Instance._twoHandedRecklessCharge;

		public static PerkObject ThickHides => Instance._twoHandedThickHides;

		public static PerkObject BladeMaster => Instance._twoHandedBladeMaster;

		public static PerkObject Vandal => Instance._twoHandedVandal;

		public static PerkObject WayOfTheGreatAxe => Instance._twoHandedWayOfTheGreatAxe;
	}

	public static class Polearm
	{
		public static PerkObject Pikeman => Instance._polearmPikeman;

		public static PerkObject Cavalry => Instance._polearmCavalry;

		public static PerkObject Braced => Instance._polearmBraced;

		public static PerkObject KeepAtBay => Instance._polearmKeepAtBay;

		public static PerkObject SwiftSwing => Instance._polearmSwiftSwing;

		public static PerkObject CleanThrust => Instance._polearmCleanThrust;

		public static PerkObject Footwork => Instance._polearmFootwork;

		public static PerkObject HardKnock => Instance._polearmHardKnock;

		public static PerkObject SteedKiller => Instance._polearmSteedKiller;

		public static PerkObject Lancer => Instance._polearmLancer;

		public static PerkObject Skewer => Instance._polearmSkewer;

		public static PerkObject Guards => Instance._polearmGuards;

		public static PerkObject StandardBearer => Instance._polearmStandardBearer;

		public static PerkObject Phalanx => Instance._polearmPhalanx;

		public static PerkObject HardyFrontline => Instance._polearmHardyFrontline;

		public static PerkObject Drills => Instance._polearmDrills;

		public static PerkObject SureFooted => Instance._polearmSureFooted;

		public static PerkObject UnstoppableForce => Instance._polearmUnstoppableForce;

		public static PerkObject CounterWeight => Instance._polearmCounterweight;

		public static PerkObject SharpenTheTip => Instance._polearmSharpenTheTip;

		public static PerkObject WayOfTheSpear => Instance._polearmWayOfTheSpear;
	}

	public static class Bow
	{
		public static PerkObject BowControl => Instance._bowBowControl;

		public static PerkObject DeadAim => Instance._bowDeadAim;

		public static PerkObject Bodkin => Instance._bowBodkin;

		public static PerkObject RangersSwiftness => Instance._bowRangersSwiftness;

		public static PerkObject RapidFire => Instance._bowRapidFire;

		public static PerkObject QuickAdjustments => Instance._bowQuickAdjustments;

		public static PerkObject MerryMen => Instance._bowMerryMen;

		public static PerkObject MountedArchery => Instance._bowMountedArchery;

		public static PerkObject Trainer => Instance._bowTrainer;

		public static PerkObject StrongBows => Instance._bowStrongBows;

		public static PerkObject Discipline => Instance._bowDiscipline;

		public static PerkObject HunterClan => Instance._bowHunterClan;

		public static PerkObject SkirmishPhaseMaster => Instance._bowSkirmishPhaseMaster;

		public static PerkObject EagleEye => Instance._bowEagleEye;

		public static PerkObject BullsEye => Instance._bowBullsEye;

		public static PerkObject RenownedArcher => Instance._bowRenownedArcher;

		public static PerkObject HorseMaster => Instance._bowHorseMaster;

		public static PerkObject DeepQuivers => Instance._bowDeepQuivers;

		public static PerkObject QuickDraw => Instance._bowQuickDraw;

		public static PerkObject NockingPoint => Instance._bowNockingPoint;

		public static PerkObject Deadshot => Instance._bowDeadshot;
	}

	public static class Crossbow
	{
		public static PerkObject Piercer => Instance._crossbowPiercer;

		public static PerkObject Marksmen => Instance._crossbowMarksmen;

		public static PerkObject Unhorser => Instance._crossbowUnhorser;

		public static PerkObject WindWinder => Instance._crossbowWindWinder;

		public static PerkObject DonkeysSwiftness => Instance._crossbowDonkeysSwiftness;

		public static PerkObject Sheriff => Instance._crossbowSheriff;

		public static PerkObject PeasantLeader => Instance._crossbowPeasantLeader;

		public static PerkObject RenownMarksmen => Instance._crossbowRenownMarksmen;

		public static PerkObject Fletcher => Instance._crossbowFletcher;

		public static PerkObject Puncture => Instance._crossbowPuncture;

		public static PerkObject LooseAndMove => Instance._crossbowLooseAndMove;

		public static PerkObject DeftHands => Instance._crossbowDeftHands;

		public static PerkObject CounterFire => Instance._crossbowCounterFire;

		public static PerkObject MountedCrossbowman => Instance._crossbowMountedCrossbowman;

		public static PerkObject Steady => Instance._crossbowSteady;

		public static PerkObject LongShots => Instance._crossbowLongShots;

		public static PerkObject HammerBolts => Instance._crossbowHammerBolts;

		public static PerkObject Pavise => Instance._crossbowPavise;

		public static PerkObject Terror => Instance._crossbowTerror;

		public static PerkObject PickedShots => Instance._crossbowPickedShots;

		public static PerkObject MightyPull => Instance._crossbowMightyPull;
	}

	public static class Throwing
	{
		public static PerkObject QuickDraw => Instance._throwingQuickDraw;

		public static PerkObject ShieldBreaker => Instance._throwingShieldBreaker;

		public static PerkObject Hunter => Instance._throwingHunter;

		public static PerkObject FlexibleFighter => Instance._throwingFlexibleFighter;

		public static PerkObject MountedSkirmisher => Instance._throwingMountedSkirmisher;

		public static PerkObject PerfectTechnique => Instance._throwingPerfectTechnique;

		public static PerkObject RunningThrow => Instance._throwingRunningThrow;

		public static PerkObject KnockOff => Instance._throwingKnockOff;

		public static PerkObject WellPrepared => Instance._throwingWellPrepared;

		public static PerkObject Skirmisher => Instance._throwingSkirmisher;

		public static PerkObject Focus => Instance._throwingFocus;

		public static PerkObject LastHit => Instance._throwingLastHit;

		public static PerkObject HeadHunter => Instance._throwingHeadHunter;

		public static PerkObject ThrowingCompetitions => Instance._throwingThrowingCompetitions;

		public static PerkObject Saddlebags => Instance._throwingSaddlebags;

		public static PerkObject Splinters => Instance._throwingSplinters;

		public static PerkObject Resourceful => Instance._throwingResourceful;

		public static PerkObject LongReach => Instance._throwingLongReach;

		public static PerkObject WeakSpot => Instance._throwingWeakSpot;

		public static PerkObject Impale => Instance._throwingImpale;

		public static PerkObject UnstoppableForce => Instance._throwingUnstoppableForce;
	}

	public static class Riding
	{
		public static PerkObject FullSpeed => Instance._ridingFullSpeed;

		public static PerkObject NimbleSteed => Instance._ridingNimbleSteed;

		public static PerkObject WellStraped => Instance._ridingWellStraped;

		public static PerkObject Veterinary => Instance._ridingVeterinary;

		public static PerkObject NomadicTraditions => Instance._ridingNomadicTraditions;

		public static PerkObject DeeperSacks => Instance._ridingDeeperSacks;

		public static PerkObject Sagittarius => Instance._ridingSagittarius;

		public static PerkObject SweepingWind => Instance._ridingSweepingWind;

		public static PerkObject ReliefForce => Instance._ridingReliefForce;

		public static PerkObject MountedWarrior => Instance._ridingMountedWarrior;

		public static PerkObject HorseArcher => Instance._ridingHorseArcher;

		public static PerkObject Shepherd => Instance._ridingShepherd;

		public static PerkObject Breeder => Instance._ridingBreeder;

		public static PerkObject ThunderousCharge => Instance._ridingThunderousCharge;

		public static PerkObject AnnoyingBuzz => Instance._ridingAnnoyingBuzz;

		public static PerkObject MountedPatrols => Instance._ridingMountedPatrols;

		public static PerkObject CavalryTactics => Instance._ridingCavalryTactics;

		public static PerkObject DauntlessSteed => Instance._ridingDauntlessSteed;

		public static PerkObject ToughSteed => Instance._ridingToughSteed;

		public static PerkObject TheWayOfTheSaddle => Instance._ridingTheWayOfTheSaddle;
	}

	public static class Athletics
	{
		public static PerkObject MorningExercise => Instance._athleticsMorningExercise;

		public static PerkObject WellBuilt => Instance._athleticsWellBuilt;

		public static PerkObject Fury => Instance._athleticsFury;

		public static PerkObject FormFittingArmor => Instance._athleticsFormFittingArmor;

		public static PerkObject ImposingStature => Instance._athleticsImposingStature;

		public static PerkObject Stamina => Instance._athleticsStamina;

		public static PerkObject Sprint => Instance._athleticsSprint;

		public static PerkObject Powerful => Instance._athleticsPowerful;

		public static PerkObject SurgingBlow => Instance._athleticsSurgingBlow;

		public static PerkObject Braced => Instance._athleticsBraced;

		public static PerkObject WalkItOff => Instance._athleticsWalkItOff;

		public static PerkObject AGoodDaysRest => Instance._athleticsAGoodDaysRest;

		public static PerkObject Durable => Instance._athleticsDurable;

		public static PerkObject Energetic => Instance._athleticsEnergetic;

		public static PerkObject Steady => Instance._athleticsSteady;

		public static PerkObject Strong => Instance._athleticsStrong;

		public static PerkObject StrongLegs => Instance._athleticsStrongLegs;

		public static PerkObject StrongArms => Instance._athleticsStrongArms;

		public static PerkObject Spartan => Instance._athleticsSpartan;

		public static PerkObject IgnorePain => Instance._athleticsIgnorePain;

		public static PerkObject MightyBlow => Instance._athleticsMightyBlow;
	}

	public static class Crafting
	{
		public static PerkObject IronMaker => Instance._craftingIronMaker;

		public static PerkObject CharcoalMaker => Instance._craftingCharcoalMaker;

		public static PerkObject SteelMaker => Instance._craftingSteelMaker;

		public static PerkObject SteelMaker2 => Instance._craftingSteelMaker2;

		public static PerkObject SteelMaker3 => Instance._craftingSteelMaker3;

		public static PerkObject CuriousSmelter => Instance._craftingCuriousSmelter;

		public static PerkObject CuriousSmith => Instance._craftingCuriousSmith;

		public static PerkObject PracticalRefiner => Instance._craftingPracticalRefiner;

		public static PerkObject PracticalSmelter => Instance._craftingPracticalSmelter;

		public static PerkObject PracticalSmith => Instance._craftingPracticalSmith;

		public static PerkObject ArtisanSmith => Instance._craftingArtisanSmith;

		public static PerkObject ExperiencedSmith => Instance._craftingExperiencedSmith;

		public static PerkObject MasterSmith => Instance._craftingMasterSmith;

		public static PerkObject LegendarySmith => Instance._craftingLegendarySmith;

		public static PerkObject VigorousSmith => Instance._craftingVigorousSmith;

		public static PerkObject StrongSmith => Instance._craftingStrongSmith;

		public static PerkObject EnduringSmith => Instance._craftingEnduringSmith;

		public static PerkObject WeaponMasterSmith => Instance._craftingFencerSmith;

		public static PerkObject SharpenedEdge => Instance._craftingSharpenedEdge;

		public static PerkObject SharpenedTip => Instance._craftingSharpenedTip;
	}

	public static class Scouting
	{
		public static PerkObject DayTraveler => Instance._scoutingDayTraveler;

		public static PerkObject Pathfinder => Instance._scoutingPathfinder;

		public static PerkObject NightRunner => Instance._scoutingNightRunner;

		public static PerkObject WaterDiviner => Instance._scoutingWaterDiviner;

		public static PerkObject ForestKin => Instance._scoutingForestKin;

		public static PerkObject DesertBorn => Instance._scoutingDesertBorn;

		public static PerkObject ForcedMarch => Instance._scoutingForcedMarch;

		public static PerkObject Unburdened => Instance._scoutingUnburdened;

		public static PerkObject Tracker => Instance._scoutingTracker;

		public static PerkObject Ranger => Instance._scoutingRanger;

		public static PerkObject MountedScouts => Instance._scoutingMountedScouts;

		public static PerkObject Patrols => Instance._scoutingPatrols;

		public static PerkObject Foragers => Instance._scoutingForagers;

		public static PerkObject BeastWhisperer => Instance._scoutingBeastWhisperer;

		public static PerkObject VillageNetwork => Instance._scoutingVillageNetwork;

		public static PerkObject RumourNetwork => Instance._scoutingRumourNetwork;

		public static PerkObject VantagePoint => Instance._scoutingVantagePoint;

		public static PerkObject KeenSight => Instance._scoutingKeenSight;

		public static PerkObject Vanguard => Instance._scoutingVanguard;

		public static PerkObject Rearguard => Instance._scoutingRearguard;

		public static PerkObject UncannyInsight => Instance._scoutingUncannyInsight;
	}

	public static class Tactics
	{
		public static PerkObject TightFormations => Instance._tacticsTightFormations;

		public static PerkObject LooseFormations => Instance._tacticsLooseFormations;

		public static PerkObject ExtendedSkirmish => Instance._tacticsExtendedSkirmish;

		public static PerkObject DecisiveBattle => Instance._tacticsDecisiveBattle;

		public static PerkObject SmallUnitTactics => Instance._tacticsSmallUnitTactics;

		public static PerkObject HordeLeader => Instance._tacticsHordeLeader;

		public static PerkObject LawKeeper => Instance._tacticsLawKeeper;

		public static PerkObject Coaching => Instance._tacticsCoaching;

		public static PerkObject SwiftRegroup => Instance._tacticsSwiftRegroup;

		public static PerkObject Improviser => Instance._tacticsImproviser;

		public static PerkObject OnTheMarch => Instance._tacticsOnTheMarch;

		public static PerkObject CallToArms => Instance._tacticsCallToArms;

		public static PerkObject PickThemOfTheWalls => Instance._tacticsPickThemOfTheWalls;

		public static PerkObject MakeThemPay => Instance._tacticsMakeThemPay;

		public static PerkObject EliteReserves => Instance._tacticsEliteReserves;

		public static PerkObject Encirclement => Instance._tacticsEncirclement;

		public static PerkObject PreBattleManeuvers => Instance._tacticsPreBattleManeuvers;

		public static PerkObject Besieged => Instance._tacticsBesieged;

		public static PerkObject Counteroffensive => Instance._tacticsCounteroffensive;

		public static PerkObject Gensdarmes => Instance._tacticsGensdarmes;

		public static PerkObject TacticalMastery => Instance._tacticsTacticalMastery;
	}

	public static class Roguery
	{
		public static PerkObject NoRestForTheWicked => Instance._rogueryNoRestForTheWicked;

		public static PerkObject SweetTalker => Instance._roguerySweetTalker;

		public static PerkObject TwoFaced => Instance._rogueryTwoFaced;

		public static PerkObject DeepPockets => Instance._rogueryDeepPockets;

		public static PerkObject InBestLight => Instance._rogueryInBestLight;

		public static PerkObject KnowHow => Instance._rogueryKnowHow;

		public static PerkObject Promises => Instance._rogueryPromises;

		public static PerkObject Manhunter => Instance._rogueryManhunter;

		public static PerkObject Scarface => Instance._rogueryScarface;

		public static PerkObject WhiteLies => Instance._rogueryWhiteLies;

		public static PerkObject SmugglerConnections => Instance._roguerySmugglerConnections;

		public static PerkObject PartnersInCrime => Instance._rogueryPartnersInCrime;

		public static PerkObject OneOfTheFamily => Instance._rogueryOneOfTheFamily;

		public static PerkObject SaltTheEarth => Instance._roguerySaltTheEarth;

		public static PerkObject Carver => Instance._rogueryCarver;

		public static PerkObject RansomBroker => Instance._rogueryRansomBroker;

		public static PerkObject ArmsDealer => Instance._rogueryArmsDealer;

		public static PerkObject DirtyFighting => Instance._rogueryDirtyFighting;

		public static PerkObject DashAndSlash => Instance._rogueryDashAndSlash;

		public static PerkObject FleetFooted => Instance._rogueryFleetFooted;

		public static PerkObject RogueExtraordinaire => Instance._rogueryRogueExtraordinaire;
	}

	public static class Charm
	{
		public static PerkObject Virile => Instance._charmVirile;

		public static PerkObject SelfPromoter => Instance._charmSelfPromoter;

		public static PerkObject Oratory => Instance._charmOratory;

		public static PerkObject Warlord => Instance._charmWarlord;

		public static PerkObject ForgivableGrievances => Instance._charmForgivableGrievances;

		public static PerkObject MeaningfulFavors => Instance._charmMeaningfulFavors;

		public static PerkObject InBloom => Instance._charmInBloom;

		public static PerkObject YoungAndRespectful => Instance._charmYoungAndRespectful;

		public static PerkObject Firebrand => Instance._charmFirebrand;

		public static PerkObject FlexibleEthics => Instance._charmFlexibleEthics;

		public static PerkObject EffortForThePeople => Instance._charmEffortForThePeople;

		public static PerkObject SlickNegotiator => Instance._charmSlickNegotiator;

		public static PerkObject GoodNatured => Instance._charmGoodNatured;

		public static PerkObject Tribute => Instance._charmTribute;

		public static PerkObject MoralLeader => Instance._charmMoralLeader;

		public static PerkObject NaturalLeader => Instance._charmNaturalLeader;

		public static PerkObject PublicSpeaker => Instance._charmPublicSpeaker;

		public static PerkObject Parade => Instance._charmParade;

		public static PerkObject Camaraderie => Instance._charmCamaraderie;

		public static PerkObject ImmortalCharm => Instance._charmImmortalCharm;
	}

	public static class Leadership
	{
		public static PerkObject CombatTips => Instance._leadershipCombatTips;

		public static PerkObject RaiseTheMeek => Instance._leadershipRaiseTheMeek;

		public static PerkObject FerventAttacker => Instance._leadershipFerventAttacker;

		public static PerkObject StoutDefender => Instance._leadershipStoutDefender;

		public static PerkObject Authority => Instance._leadershipAuthority;

		public static PerkObject HeroicLeader => Instance._leadershipHeroicLeader;

		public static PerkObject LoyaltyAndHonor => Instance._leadershipLoyaltyAndHonor;

		public static PerkObject Presence => Instance._leadershipPresence;

		public static PerkObject FamousCommander => Instance._leadershipFamousCommander;

		public static PerkObject LeaderOfMasses => Instance._leadershipLeaderOfTheMasses;

		public static PerkObject VeteransRespect => Instance._leadershipVeteransRespect;

		public static PerkObject CitizenMilitia => Instance._leadershipCitizenMilitia;

		public static PerkObject InspiringLeader => Instance._leadershipInspiringLeader;

		public static PerkObject UpliftingSpirit => Instance._leadershipUpliftingSpirit;

		public static PerkObject MakeADifference => Instance._leadershipMakeADifference;

		public static PerkObject LeadByExample => Instance._leadershipLeadByExample;

		public static PerkObject TrustedCommander => Instance._leadershipTrustedCommander;

		public static PerkObject GreatLeader => Instance._leadershipGreatLeader;

		public static PerkObject WePledgeOurSwords => Instance._leadershipWePledgeOurSwords;

		public static PerkObject TalentMagnet => Instance._leadershipTalentMagnet;

		public static PerkObject UltimateLeader => Instance._leadershipUltimateLeader;
	}

	public static class Trade
	{
		public static PerkObject Appraiser => Instance._tradeAppraiser;

		public static PerkObject WholeSeller => Instance._tradeWholeSeller;

		public static PerkObject CaravanMaster => Instance._tradeCaravanMaster;

		public static PerkObject MarketDealer => Instance._tradeMarketDealer;

		public static PerkObject TravelingRumors => Instance._tradeTravelingRumors;

		public static PerkObject LocalConnection => Instance._tradeLocalConnection;

		public static PerkObject DistributedGoods => Instance._tradeDistributedGoods;

		public static PerkObject Tollgates => Instance._tradeTollgates;

		public static PerkObject ArtisanCommunity => Instance._tradeArtisanCommunity;

		public static PerkObject GreatInvestor => Instance._tradeGreatInvestor;

		public static PerkObject MercenaryConnections => Instance._tradeMercenaryConnections;

		public static PerkObject ContentTrades => Instance._tradeContentTrades;

		public static PerkObject InsurancePlans => Instance._tradeInsurancePlans;

		public static PerkObject RapidDevelopment => Instance._tradeRapidDevelopment;

		public static PerkObject GranaryAccountant => Instance._tradeGranaryAccountant;

		public static PerkObject TradeyardForeman => Instance._tradeTradeyardForeman;

		public static PerkObject SwordForBarter => Instance._tradeSwordForBarter;

		public static PerkObject SelfMadeMan => Instance._tradeSelfMadeMan;

		public static PerkObject SilverTongue => Instance._tradeSilverTongue;

		public static PerkObject SpringOfGold => Instance._tradeSpringOfGold;

		public static PerkObject ManOfMeans => Instance._tradeManOfMeans;

		public static PerkObject TrickleDown => Instance._tradeTrickleDown;

		public static PerkObject EverythingHasAPrice => Instance._tradeEverythingHasAPrice;
	}

	public static class Steward
	{
		public static PerkObject WarriorsDiet => Instance._stewardWarriorsDiet;

		public static PerkObject Frugal => Instance._stewardFrugal;

		public static PerkObject SevenVeterans => Instance._stewardSevenVeterans;

		public static PerkObject DrillSergant => Instance._stewardDrillSergant;

		public static PerkObject Sweatshops => Instance._stewardSweatshops;

		public static PerkObject StiffUpperLip => Instance._stewardStiffUpperLip;

		public static PerkObject PaidInPromise => Instance._stewardPaidInPromise;

		public static PerkObject EfficientCampaigner => Instance._stewardEfficientCampaigner;

		public static PerkObject GivingHands => Instance._stewardGivingHands;

		public static PerkObject Logistician => Instance._stewardLogistician;

		public static PerkObject Relocation => Instance._stewardRelocation;

		public static PerkObject AidCorps => Instance._stewardAidCorps;

		public static PerkObject Gourmet => Instance._stewardGourmet;

		public static PerkObject SoundReserves => Instance._stewardSoundReserves;

		public static PerkObject ForcedLabor => Instance._stewardForcedLabor;

		public static PerkObject Contractors => Instance._stewardContractors;

		public static PerkObject ArenicosMules => Instance._stewardArenicosMules;

		public static PerkObject ArenicosHorses => Instance._stewardArenicosHorses;

		public static PerkObject MasterOfPlanning => Instance._stewardMasterOfPlanning;

		public static PerkObject MasterOfWarcraft => Instance._stewardMasterOfWarcraft;

		public static PerkObject PriceOfLoyalty => Instance._stewardPriceOfLoyalty;
	}

	public static class Medicine
	{
		public static PerkObject SelfMedication => Instance._medicineSelfMedication;

		public static PerkObject PreventiveMedicine => Instance._medicinePreventiveMedicine;

		public static PerkObject TriageTent => Instance._medicineTriageTent;

		public static PerkObject WalkItOff => Instance._medicineWalkItOff;

		public static PerkObject Sledges => Instance._medicineSledges;

		public static PerkObject DoctorsOath => Instance._medicineDoctorsOath;

		public static PerkObject BestMedicine => Instance._medicineBestMedicine;

		public static PerkObject GoodLogdings => Instance._medicineGoodLodging;

		public static PerkObject SiegeMedic => Instance._medicineSiegeMedic;

		public static PerkObject Veterinarian => Instance._medicineVeterinarian;

		public static PerkObject PristineStreets => Instance._medicinePristineStreets;

		public static PerkObject BushDoctor => Instance._medicineBushDoctor;

		public static PerkObject PerfectHealth => Instance._medicinePerfectHealth;

		public static PerkObject HealthAdvise => Instance._medicineHealthAdvise;

		public static PerkObject PhysicianOfPeople => Instance._medicinePhysicianOfPeople;

		public static PerkObject CleanInfrastructure => Instance._medicineCleanInfrastructure;

		public static PerkObject CheatDeath => Instance._medicineCheatDeath;

		public static PerkObject FortitudeTonic => Instance._medicineFortitudeTonic;

		public static PerkObject HelpingHands => Instance._medicineHelpingHands;

		public static PerkObject BattleHardened => Instance._medicineBattleHardened;

		public static PerkObject MinisterOfHealth => Instance._medicineMinisterOfHealth;
	}

	public static class Engineering
	{
		public static PerkObject Scaffolds => Instance._engineeringScaffolds;

		public static PerkObject TorsionEngines => Instance._engineeringTorsionEngines;

		public static PerkObject SiegeWorks => Instance._engineeringSiegeWorks;

		public static PerkObject DungeonArchitect => Instance._engineeringDungeonArchitect;

		public static PerkObject Carpenters => Instance._engineeringCarpenters;

		public static PerkObject MilitaryPlanner => Instance._engineeringMilitaryPlanner;

		public static PerkObject WallBreaker => Instance._engineeringWallBreaker;

		public static PerkObject DreadfulSieger => Instance._engineeringDreadfulSieger;

		public static PerkObject Salvager => Instance._engineeringSalvager;

		public static PerkObject Foreman => Instance._engineeringForeman;

		public static PerkObject Stonecutters => Instance._engineeringStonecutters;

		public static PerkObject SiegeEngineer => Instance._engineeringSiegeEngineer;

		public static PerkObject CampBuilding => Instance._engineeringCampBuilding;

		public static PerkObject Battlements => Instance._engineeringBattlements;

		public static PerkObject EngineeringGuilds => Instance._engineeringEngineeringGuilds;

		public static PerkObject Apprenticeship => Instance._engineeringApprenticeship;

		public static PerkObject Metallurgy => Instance._engineeringMetallurgy;

		public static PerkObject ImprovedTools => Instance._engineeringImprovedTools;

		public static PerkObject Clockwork => Instance._engineeringClockwork;

		public static PerkObject ArchitecturalCommisions => Instance._engineeringArchitecturalCommisions;

		public static PerkObject Masterwork => Instance._engineeringMasterwork;
	}
