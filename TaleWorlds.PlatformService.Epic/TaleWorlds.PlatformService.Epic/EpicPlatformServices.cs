...
public class EpicPlatformServices : IPlatformServices
{
	...
	private bool Connect()
	{
		...
		OnCreateUserCallback val5 = default(OnCreateUserCallback);
		_platform.GetConnectInterface().Login(ref val4, (object)null, (OnLoginCallback)delegate(ref LoginCallbackInfo data)
		{
			...
			{
				CreateUserOptions val7 = default(CreateUserOptions);
				((CreateUserOptions)(ref val7)).ContinuanceToken = ((LoginCallbackInfo)(ref data)).ContinuanceToken;
				CreateUserOptions val8 = val7;
				ConnectInterface connectInterface = _platform.GetConnectInterface();
				OnCreateUserCallback obj = val5;
				if (obj == null)
				{
				...
				connectInterface.CreateUser(ref val8, (object)null, obj);
			}
		...
		AddNotifyAuthExpirationOptions val6 = default(AddNotifyAuthExpirationOptions);
		_refreshConnectionCallbackId = _platform.GetConnectInterface().AddNotifyAuthExpiration(ref val6, (object)val2, new OnAuthExpirationCallback(RefreshConnection));
		QueryStats();
		QueryDefinitions();
		return true;
	}
