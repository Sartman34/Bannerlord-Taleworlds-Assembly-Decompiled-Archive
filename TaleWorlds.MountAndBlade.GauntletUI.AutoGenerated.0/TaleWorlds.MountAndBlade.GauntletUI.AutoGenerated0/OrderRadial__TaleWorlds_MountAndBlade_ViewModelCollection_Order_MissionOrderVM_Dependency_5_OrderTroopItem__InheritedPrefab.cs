...
public class OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_5_OrderTroopItem__InheritedPrefab : OrderTroopItemBrushWidget
{
	...
	public OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_5_OrderTroopItem__InheritedPrefab(UIContext context)
		: base(context)
	{
	}
	...
	public virtual void DestroyDataSource()
	{
		...
		if (_datasource_Root_ActiveFormationClasses != null)
		{
			...
			for (int num = _widget_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate)_widget_0.GetChild(num)).DestroyDataSource();
			}
		...
		if (_datasource_Root_ActiveFilters != null)
		{
			...
			for (int num2 = _widget_7.ChildCount - 1; num2 >= 0; num2--)
			{
				...
				((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate)_widget_7.GetChild(num2)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_ActiveFormationClassesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate, e.NewIndex);
			...
			orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
			Widget child2 = _widget_0.GetChild(e.NewIndex);
			((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate)child2).OnBeforeRemovedChild(child2);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			Widget child = _widget_0.GetChild(e.NewIndex);
			((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate)child).SetDataSource(null);
	...
	public void OnList_datasource_Root_ActiveFiltersChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_7.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate, e.NewIndex);
			...
			orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetDataSource(dataSource);
			break;
		}
		case TaleWorlds.Library.ListChangedType.ItemBeforeDeleted:
		{
		...
		case TaleWorlds.Library.ListChangedType.ItemDeleted:
		{
			...
			((OrderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate)child).SetDataSource(null);
	...
	private void RefreshDataSource_datasource_Root(OrderTroopItemVM newDataSource)
	{
		...
		if (_datasource_Root_ActiveFormationClasses != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ActiveFormationClasses.Count; i++)
			{
				...
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate, i);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate.SetAttributes();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_11_ItemTemplate.SetDataSource(dataSource);
		...
		if (_datasource_Root_ActiveFilters != null)
		{
			...
			for (int j = 0; j < _datasource_Root_ActiveFilters.Count; j++)
			{
				...
				_widget_7.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate, j);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetAttributes();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetDataSource(dataSource2);
			}
		}
	}
	...
	private void RefreshDataSource_datasource_Root_ActiveFilters(MBBindingList<OrderTroopItemFilterVM> newDataSource)
	{
		...
		if (_datasource_Root_ActiveFilters != null)
		{
			...
			for (int i = 0; i < _datasource_Root_ActiveFilters.Count; i++)
			{
				...
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_7.AddChildAtIndex(orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate, i);
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.CreateWidgets();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetIds();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetAttributes();
				orderRadial__TaleWorlds_MountAndBlade_ViewModelCollection_Order_MissionOrderVM_Dependency_12_ItemTemplate.SetDataSource(dataSource);
