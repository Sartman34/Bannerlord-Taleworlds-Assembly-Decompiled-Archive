...
public class SiegeTower : SiegeWeapon, IPathHolder, IPrimarySiegeWeapon, IMoveableSiegeWeapon, ISpawnable
{
	...
	protected internal override void OnTickParallel(float dt)
	{
		...
		if (_gateStandingPoint.HasUser)
		{
			...
			Agent userAgent2 = _gateStandingPoint.UserAgent;
			ref MatrixFrame gateStandingPointLocalIKFrame = ref _gateStandingPointLocalIKFrame;
			MatrixFrame boundEntityGlobalFrame = CleanState.GetGlobalFrame();
			userAgent2.SetHandInverseKinematicsFrameForMissionObjectUsage(in gateStandingPointLocalIKFrame, in boundEntityGlobalFrame);
		}
	}
