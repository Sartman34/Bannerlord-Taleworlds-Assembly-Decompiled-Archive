...
public class CharacterTableau
{
	...
	public void OnTick(float dt)
	{
		...
		if (_agentVisualLoadingCounter > 0 && _agentVisuals.GetEntity().CheckResources(addToQueue: true, checkFaceResources: true))
		{
			_agentVisualLoadingCounter--;
		}
		if (_mountVisualLoadingCounter > 0 && _mountVisuals.GetEntity().CheckResources(addToQueue: true, checkFaceResources: true))
		{
