...
public class MultiplayerDuelVM : ViewModel
{
	...
	private void DebugTick()
	{
		...
		foreach (GameEntity item in Mission.Current.Scene.FindEntitiesWithTagExpression(expression))
		{
			...
			vec.x = TaleWorlds.Library.MathF.Clamp(vec.x, 0f, 1f) * Screen.RealScreenResolutionWidth;
			vec.y = TaleWorlds.Library.MathF.Clamp(vec.y, 0f, 1f) * Screen.RealScreenResolutionHeight;
		}
	}
