...
public struct Vec3
{
	...
	public Vec3 RotateAboutAnArbitraryVector(Vec3 vec, float a)
	{
		...
		result.x = num * (num4 + num8 + num12) + (x * (num2 * num2 + num3 * num3) - num * (num8 + num12)) * ca + (0f - num11 + num9) * sa;
		result.y = num2 * (num4 + num8 + num12) + (y * (num * num + num3 * num3) - num2 * (num4 + num12)) * ca + (num10 - num6) * sa;
		result.z = num3 * (num4 + num8 + num12) + (z * (num * num + num2 * num2) - num3 * (num4 + num8)) * ca + (0f - num7 + num5) * sa;
		return result;
	}
