...
public class SpanishTextProcessor : LanguageSpecificTextProcessor
{
	...
	{
		if (!CheckWhiteSpaceAndTextEnd(text, cursorPos) || (_curGender != 0 && _curGender != WordGenderEnum.MasculinePlural && _curGender != WordGenderEnum.FeminineSingular && _curGender != WordGenderEnum.FemininePlural))
		{
			return;
		}
