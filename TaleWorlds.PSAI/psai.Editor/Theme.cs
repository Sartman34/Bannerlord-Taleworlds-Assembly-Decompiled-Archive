...
public class Theme : PsaiMusicEntity, ICloneable
{
	...
	public static Theme getTestTheme1()
	{
		...
		Group group = new Group(obj, "wald_streicher");
		Group group2 = new Group(obj, "wald_choir");
		...
		group.AddSegment(snippet2);
		group.AddSegment(snippet3);
		group.AddSegment(snippet4);
		group.AddSegment(snippet5);
		group.AddSegment(snippet6);
		group2.AddSegment(snippet7);
		group2.AddSegment(snippet8);
		group2.AddSegment(snippet9);
		group2.AddSegment(snippet10);
		group2.AddSegment(snippet11);
		group2.AddSegment(snippet12);
		obj.AddGroup(group);
		obj.AddGroup(group2);
		return obj;
	}
	...
	public static Theme getTestTheme2()
	{
		...
		Group group = new Group(obj, "cave horns");
		Group group2 = new Group(obj, "cave choir");
