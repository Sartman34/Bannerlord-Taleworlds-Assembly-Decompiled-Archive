	...
	public void DeleteMusicEntity(PsaiMusicEntity entity)
	{
		...
		if (entity is Group)
		{
			...
			}
			{
				...
				{
					if (groupsOfAllTheme.ManuallyBlockedGroups.Contains(group))
					{
						groupsOfAllTheme.ManuallyBlockedGroups.Remove(group);
					}
					if (groupsOfAllTheme.ManuallyLinkedGroups.Contains(group))
					{
						groupsOfAllTheme.ManuallyLinkedGroups.Remove(group);
					}
				}
				return;
			}
