...
public class RangedHeadShotDamageEffect : MPPerkEffect
{
	...
	protected override void Deserialize(XmlNode node)
	{
		...
		{
			Debug.FailedAssert("provided 'value' is invalid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer\\Perks\\Effects\\RangedHeadShotDamageEffect.cs", "Deserialize", 22);
		}
	}
