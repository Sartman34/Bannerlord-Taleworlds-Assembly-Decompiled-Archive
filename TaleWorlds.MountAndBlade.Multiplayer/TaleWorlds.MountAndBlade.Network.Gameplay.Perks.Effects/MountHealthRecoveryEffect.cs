...
public class MountHealthRecoveryEffect : MPPerkEffect
{
	...
	protected override void Deserialize(XmlNode node)
	{
		...
		{
			Debug.FailedAssert("provided 'value' is invalid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer\\Perks\\Effects\\MountHealthRecoveryEffect.cs", "Deserialize", 29);
		}
		string text2 = node?.Attributes?["period"]?.Value;
		if (text2 == null || !int.TryParse(text2, out _period) || _period < 1)
		{
			Debug.FailedAssert("provided 'period' is invalid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer\\Perks\\Effects\\MountHealthRecoveryEffect.cs", "Deserialize", 35);
		}
	}
