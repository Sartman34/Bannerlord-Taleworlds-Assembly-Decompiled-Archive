...
public class DamageInterruptionThresholdEffect : MPPerkEffect
{
	...
	protected override void Deserialize(XmlNode node)
	{
		...
		{
			Debug.FailedAssert("provided 'value' is invalid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer\\Perks\\Effects\\DamageInterruptionThresholdEffect.cs", "Deserialize", 23);
		}
	}
