...
public class ShieldDamageEffect : MPPerkEffect
{
	...
	protected override void Deserialize(XmlNode node)
	{
		...
		{
			Debug.FailedAssert("provided 'value' is invalid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer\\Perks\\Effects\\ShieldDamageEffect.cs", "Deserialize", 31);
		}
		...
		{
			_blockType = BlockType.Any;
			Debug.FailedAssert("provided 'block_type' is invalid", "C:\\Develop\\MB3\\Source\\Bannerlord\\TaleWorlds.MountAndBlade.Multiplayer\\Perks\\Effects\\ShieldDamageEffect.cs", "Deserialize", 39);
		}
	}
